...
\item \textbf{Filtro por vocabulario}: Con el propósito de mantener palabras \quotes{humanamente legibles} se utiliza un vocabulario. Para esto se utiliza el vocabulario del corpus SUC descrito en el capítulo anterior, de esta menera toda palabra tiene su \textit{word embedding}. 
