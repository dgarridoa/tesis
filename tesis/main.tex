...
\def\imagendepartamento {img/departments/uchile2.pdf}
...
La distribución Dirichlet es una generalización multivariada de la distribución beta, la cual tiene soporte sobre un \textbraceleft{simplex}, definido por:
\begin{equation}
...
\begin{figure}
    \centering
    \includegraphics[width=0.65\textwidth]{math/dirichlet_simplex.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.7\textwidth]{math/dirichlet_samples.png}
...
\subsubsubsection{Chinese Restaurant Process}
....
