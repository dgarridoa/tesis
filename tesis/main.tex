...
\todo{Por qué es un caso interesante para testear la metodología}
...
\todo{Mejorar nexo con la metodología propuesta}
...
\todo[inline]{Organización del contenido}
...
En este trabajo se utiliza la implementación en C++ \citep{HDP} de este algoritmo.
