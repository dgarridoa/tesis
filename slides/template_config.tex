...
\def\documentfontsize {9}         % Tamaño de la fuente del documento [pt]
...
\def\fontdocument {notoserif}        % Tipografía base, ver soportadas en manual
...
\def\equationcaptioncenter {false}  % Ecuaciones están centradas o justificadas
...
\def\linkcolor {blue}             % Color de los links del documento
