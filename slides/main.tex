...
\begin{columns}[t]
  ...
  \begin{center}
    ...
    \begin{itemize}
   % Poner esta cifra en contexoto. Un computador de un tera por persona en el mundo 
...
% Describir problema y por que es importante
% Describir la base de datos
\begin{figure}
\includegraphics[width=0.4\textwidth]{robberies_aach.eps}
\end{figure}
\end{frame}
...
\begin{column}{0.5\textwidth}
\begin{figure}
    \includegraphics[trim={1.155cm 1.3cm 0 0},clip,width=0.3\textwidth]{cum_dist_1.eps}
\end{figure}

\begin{figure}
\includegraphics[trim={1.155cm 1.3cm 0 0},clip,width=0.3\textwidth]{cum_dist_6.eps}
\end{figure}
\end{column}
\end{columns}
\end{frame}
...
\begin{figure}
\subfloat[$\zeta$ = 0]{
  \includegraphics[width=0.4\textwidth]{graph_q100.png}
}
\subfloat[$\zeta$ = 0.9]{
  \includegraphics[width=0.4\textwidth]{graph_q100_e90.png}
}\\
\subfloat[$\zeta$ = 0.95]{
  \includegraphics[width=0.4\textwidth]{graph_q100_e95.png}
}
\subfloat[$\zeta$ = 0.99]{
  \includegraphics[width=0.4\textwidth]{graph_q100_e99.png}
}
\end{figure}

\begin{figure}
\includegraphics[width=\textwidth]{topics_evolution.eps}
\end{figure}
...
\begin{figure}
\includegraphics[width=\textwidth]{speedup.eps}
\end{figure}
\end{frame}
