...
\def\importtikz {true}            % Utilizar la librería tikz
...
\def\natbibnumbers {false}          % Forza el uso de números en la bibliografía
\def\natbibrefsep {6}              % Separación entre referencia {natbib} [pt]
\def\natbibrefstyle {unsrtnat}     % Formato de ref. natbib {apa,ieeetr,etc...} 
%ordenar bibliografía por orden de aparición
\def\natbibsquare {false}           % Usa [] o () en las numeraciones
